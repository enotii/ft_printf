...
$(NAME):
	...
	clang -o $(NAME) ft_parse.o ft_print_pointer.o ft_print_string_char.o ft_print_unsigned.o ft_print_int.o ft_print_x.o ft_print_octal.o help_functions.o ft_printf.o -I libft/ -L libft/ -lft
clean:
	rm -rf libft/*.o
	rm -rf *.o
fclean: clean
